//var mod_mirror = require('./mod_mirror'); //mod_cli_mirror
//var mod_half = require('./mod_half'); //mod_cli_half
...
function mod_nova_rotate2_cliped_rotate_wrapper(imageData,ang_rn)
{
	...
	var imageData2 = mod_nova_rotate2_combo_cliped(imageData01,imageData11);
	 ...
	 imageData2 = vortex(mod_cli_half_half(imageData2));
...
function mod_nova_rotate2_rotate_nova_auto(imageData,ang_rn)
{
	...
	var im2 = getNewImageData(w*3/2,h*3/2);
...
function getColorArrayFromImageData(imgData0, x, y)
{
	...
	function newcroplt(ish_png,  crop_settings)
	{
			...
			var newpng = getNewImageData(w-xw,h-yh);
	...
	function newcroprb(ish_png, crop_settings)
	{
			...
			var newpng = getNewImageData(xw+1,yh+1);
...
{
	imgDataResult = mod_cli_mirror_mirror_right(imgDataResult);
				
	return mod_cli_mirror_mirror_down(imgDataResult);
}
