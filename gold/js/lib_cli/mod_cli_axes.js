...
function mod_cli_axes_bothAxesMinus(im0)
{
	...
	var im = getNewImageData(w-1,h-1);
...
function getSomePart(im, sw,sh, nw, nh)
{
	...
	var newpng = getNewImageData(nw,nh);
...
function mod_cli_axes_both_axes_plus(im)
{
	...
	var result_png = getNewImageData( im.width+1,im.height+1);
