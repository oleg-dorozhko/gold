...
function __whenUserClickOnRemoveClusterButton(x,y)
{
	...
	*/	
	...
	//var c2 = global_table_of_clusters[global_cluster_number]
	var c1=global_table_of_clusters[global_cluster_number].color;
	if( (c1[0] == 0) && (c1[1] == 0) && (c1[2] == 255) && (c1[3] == 255))
	{
		
		
		global_table_of_clusters.splice(global_cluster_number,1);
		var clusters = findNotInUseClustersIndexByPoint([x,y]);//findSelectedClusterIndexes();
		if(clusters != null)
		{
			if(clusters.length!=0)
