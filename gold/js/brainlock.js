...
var glob_do_not_double_click=false;
var glob_do_not_double_context=false;
function setEventListenersOnMap()
{
	return;
	
	var cnv = document.getElementById("canvas20");
		cnv.onclick = function(e){
			
			if(glob_do_not_double_click) { 
			glob_do_not_double_click=false;
			
			return;}
			
			glob_do_not_double_click=true; 
			...
			//	e = (e) ? e : event;   
				...
				return	function(){
						...
						if(is_white(color)==true) return;
						
						if(tr_black(color)==true) return;
						
						var c = "["+color.join(",")+"],";
						document.getElementById("include_colors").value += (""+c);
						glob_do_not_double_click=false;
					}
		...
		cnv.oncontextmenu = function(e){
			...
			var c = "["+color.join(",")+"],";
			document.getElementById("exclude_colors").value += (""+c);
