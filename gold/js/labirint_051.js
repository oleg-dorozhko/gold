...
function f_get_neighbours(x,y,callback)
{
	...
	// // var xhr = new XMLHttpRequest();
				...
				// // xhr.onload = function(e) {  
					...
					// var post={};
					// post["glob_session_id"]=glob_session_id;
					// post["x"]=x;
					// post["y"]=y;
					// var colors = JSON.parse(get_qty_neighbours(post));
...
function f_doLeftClickOnPixelCanvas(x,y){
	...
	var params = 'md5='+glob_session_id;
		...
		// xhr.onload = function(e) {  
			...
			var obj = JSON.parse(s_get_xy_labirint(glob_session_id));
			...
			f_pixelsPro_whenClickedOnLabirint(glob_x_left_top,glob_y_left_top);
...
function f_is_server_buzzy(callback)
{
	callback("false");
...
//	if(document.getElementById("qflag1").checked == true ) all_checked=true;
	...
	if( (obj1.frm.indexOf("galerka")!= -1 ) && (obj2.frm.indexOf("left_canvas")!= -1 ) )
	{
		...
		return move_to_back(obj1, get_allowed_move_to_back(obj1));
