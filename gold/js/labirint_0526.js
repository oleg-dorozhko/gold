	...
	function f_processing_click()
{
	...
	global_counter=0;
		...
		f_is_server_buzzy( function( data) {
				...
				if(data=='false')
				{
						...
						f_get_last_version_of_pattern( function() {  
								...
								if(global_cliked_points_array.length>0)
								{
									...
									if(click_on_white(x,y)==false)	sound();	
										...
										f_get_neighbours(x,y, function( colors ) {
											console.log("colors.length="+colors.length);
										//	if(colors.length>
											
											// labirint(x,y);
												
												f_doLeftClick(x,y,function() {
				...
				else  
				{
					...
					setTimeout( f_processing_click, 500 );
				}
	});
...
function f_pixelsPro_whenClickedOnLabirint(x,y)
{
